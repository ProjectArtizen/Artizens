...
public interface CollaborateMapper {
	 ...
	 * // 콜라보레이션 메인 출력 쿼리
	 * 
	 * @Select("Select " + " a.collaboration_id as id," +
	 ...
	 * + " from collaboration as a " + " left join collaboration_images as b_img " +
	 * " on a.collaboration_id = b_img.collaboration_id " +
	 * " left join creator as c " + " on a.creator_id = c.creator_id ")
	 ...
	 * " where a.collaboratuon_id = ${collaboratuonId}")
	 * List<CollaborationDetailDto> findcollaborationDetailAll(Long
	 * collaborationId);
	 */
