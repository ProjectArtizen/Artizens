...
public class initDb {
	...
	static class InitService {
		...
		public void dbInit1() {
			...
			// admin creator
			UploadFile creatorImage = UploadFile.createUploadFile("user1.JPG",
			...
			// user1 creator
			UploadFile creatorImage1 = UploadFile.createUploadFile("user2.JPG",
			...
			Patron patron = Patron.createPatron("creator를 도와주세요.", "이것은 내용이 들어갈 예정입니다.", creator, patronImages);
			em.persist(patron);
