...
public class CollaborateService {
	 ...
	 * 
	 * public List<CollaborationMainDto> selectAll() { List<CollaborationMainDto>
	 * result = collaborationmapper.findcollaborationMainAll(); return result; }
	 * 
	 * public List<CollaborationDetailDto>selectDetail(Long collaborationId) {
	 * List<CollaborationDetailDto> result =
	 * collaborationmapper.findcollaborationDetailAll(collaborationId); return
	 * result; }
	 */
}
